...
public class Comparator {
	...
	public void compare() {
		...
		try {
			table = createTable(compare1, compare2);
	 ...
	 *            Document with values to be printed out
	 */
	private ArrayList<String[]> createTable(Document doc1, Document doc2) {
		...
		Iterator<String> iter = setAmalgam.iterator();
		while (iter.hasNext()) {
